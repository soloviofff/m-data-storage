...
import { buildOpenApiDocument } from './openapiRuntime';
...
export async function buildServer() {
	...
	await app.register(swaggerUi, {
		...
		transformSpecification: () => buildOpenApiDocument(config.SWAGGER_SERVER_URL),
	...
	// Serve runtime-generated OpenAPI document
	app.get('/openapi.json', async () => buildOpenApiDocument(config.SWAGGER_SERVER_URL));
